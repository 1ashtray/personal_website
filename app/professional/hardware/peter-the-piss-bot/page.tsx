...
export default function PeterThePissBotPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative z-10">
            <h1 className="text-5xl font-bold text-foreground mb-6">peter the piss bot</h1>
            ...
            <div className="rounded-lg overflow-hidden border border-white/20 mb-8">
              <img src="/peter-the-piss-bot-hardware-project.jpg" alt="peter the piss bot" className="w-full" />
            </div>
          </div>
        </div>
      </div>
