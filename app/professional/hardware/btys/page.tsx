...
export default function BTYSPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative z-10">
            <h1 className="text-5xl font-bold text-foreground mb-6">BTYS</h1>
            ...
            <div className="rounded-lg overflow-hidden border border-white/20 mb-8">
              <img src="/btys-hardware-project.jpg" alt="BTYS" className="w-full" />
            </div>
          </div>
        </div>
      </div>
