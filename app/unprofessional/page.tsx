...
export default function UnprofessionalPortfolio() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative z-10">
            <h1 className="text-5xl font-bold text-foreground mb-6">Unprofessional Portfolio</h1>
            <p className="text-xl text-muted-foreground">Welcome to the fun side. Content coming soon.</p>
          </div>
        </div>
      </div>
    </div>
